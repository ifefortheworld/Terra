...
<body style="background:url(img/background2.jpg);background-repeat:no-repeat;background-color: rgba(0,0,0,0.63)">
<!--header-->
<header>
...
<div class="container">
    ...
    <div  class="hero-unit" style="background:none;margin-bottom: 0px">
        <h1 style="text-align: center;font-size: 90px;color: #ffffff">Terra</h1>
        <h2 style="text-align: center;font-size: 20px;color: #ffffff"">We All Love Sharing</h2>
        <br>
        <form class="form-search" action="/search" style="text-align: center;">
            <div class="input-append" style="margin-bottom: 20px">
                ...
                <button type="submit" class="btn" style="width: 80px"><i class="icon-search"></i> </button>
            </div>
            <br>
            ...
            <div style="margin-top: 10px">
                <p>
                    ...
                    <a href="#" style="color: #006c99"> Learn more about Terra.....</a>
                </p>
            </div>
        </form>
    </div>
...
<!--container(end)-->
<!--footer-->
<footer style="background-color: #fff;opacity: 0.8">
    <div class="container">
