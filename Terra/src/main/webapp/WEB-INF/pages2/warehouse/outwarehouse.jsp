...
<script type="text/javascript">
	...
	$(function(){
		$("#searchbtn").click(function(){
			$("#mainTable_tbody").load("/outwarehouse/table",
								{
			...
			<div id="storage">
				<div id="toolbar">
					...
					<div class="search">
						<form action="">
							<ul class="searchul">
								<li><label style="margin-right:10px;">出库日期</label> <input
...
<div id="dialog-form" title="出库登记">
	<form>
			仓库: <select id="_warehouse_id" name="_warehouse_id"
				...
				<br> <br>
				 出库日期:<input type="text" name="_date" id="_date"
