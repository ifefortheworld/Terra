...
<script type="text/javascript">
	...
	$(function(){
		$("#searchbtn").click(function(){
			$("#mainTable_tbody").load("/trackoutregistrations/table",
								{
			...
			"alterBgColor" : function(options) {
				...
				$('tbody>tr', this).click(
						function() {
							...
							$("#_distributioNo").attr("value",$(this).attr("id"));
					...
					<table id="mainTable">
						...
						<tbody id="mainTable_tbody">
							...
							<tr id="${distribution.no}">
								...
								<td>${distribution.trackOutRegistration.prepayment}</td>
...
<script>
	$(function() {
		var _distributioNo = $("#_distributioNo"), 
		_sendOutTime = $("#_sendOutTime"),

		
		_prepayment = $("#_prepayment"),

		_note = $("#_note"),

		allFields = $([]).add(_sendOutTime).add(_prepayment ).add(_note ), 
				tips = $(".validateTips");
							...
							buttons : {
								"确定" : function() {
									...
									bValid = bValid
											...
											$.post(
													"/trackoutregistrations/add",
													{
														"distributioNo" : _distributioNo 
																.val(),
														"sendOutTime" : _sendOutTime.val(),
...
<div id="dialog-form" title="出车登记">
	<form>
				配送单编号:<input type="text" name="_distributioNo" id="_distributioNo"
							class="d_text ui-widget-content ui-corner-all" readonly="readonly"/> 
			
				
				出车时间:<input type="text" name="_sendOutTime" id="_sendOutTime"
							class="date d_text ui-widget-content ui-corner-all" /> 
				
				
				出车预支款:<input type="text" name="_prepayment" id="_prepayment"
